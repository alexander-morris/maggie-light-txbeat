		...
		<div class="wrap maggie-lite-wrap">
			...
			<div class="bottom-block">
				<ul class="maggie-lite-tab-wrapper wp-clearfix">
					...
					<li><a href="<?php echo esc_url( admin_url( 'themes.php?page=maggie-lite-about&tab=more_wp' ) ); ?>"
						class="maggie-lite-tab <?php echo $active_tab == 'more_wp' ? 'maggie-lite-tab-active' : ''; ?> "><?php echo esc_html__( 'More WordPress Stuff', 'maggie-lite' ); ?>
