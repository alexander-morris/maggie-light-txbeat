...
function maggie_lite_customize_homepage( $wp_customize ) {
    ...
    if ( isset( $wp_customize->selective_refresh ) ) {
        $wp_customize->selective_refresh->add_partial( 'homepage_option_slider', array(
            'selector'        => '.slider-wrapper',
            'render_callback' => 'maggie_lite_customize_partial_slider',
        ) );
    }
    ...
    if ( isset( $wp_customize->selective_refresh ) ) {
        $wp_customize->selective_refresh->add_partial( 'feature_post_zero', array(
            'selector'        => '.below-slider-feature',
            'render_callback' => 'maggie_lite_customize_partial_featured',
        ) );
    }
    ...
    if ( isset( $wp_customize->selective_refresh ) ) {
        $wp_customize->selective_refresh->add_partial( 'feature_post_one_title', array(
            'selector'        => '.first-block',
            'render_callback' => 'maggie_lite_customize_partial_featured_one',
        ) );
    }
    ...
    if ( isset( $wp_customize->selective_refresh ) ) {
        $wp_customize->selective_refresh->add_partial( 'feature_post_two_title', array(
            'selector'        => '.second-block',
            'render_callback' => 'maggie_lite_customize_partial_featured_two',
        ) );
    }
    ...
    if ( isset( $wp_customize->selective_refresh ) ) {
        $wp_customize->selective_refresh->add_partial( 'feature_post_three_title', array(
            'selector'        => '.third-block',
            'render_callback' => 'maggie_lite_customize_partial_featured_three',
        ) );
    }
    ...
    if ( isset( $wp_customize->selective_refresh ) ) {
        $wp_customize->selective_refresh->add_partial( 'feature_post_four_title', array(
            'selector'        => '.fourth-block',
            'render_callback' => 'maggie_lite_customize_partial_featured_four',
        ) );
    }
 ...
 * Render the partials
 */
function eightstore_pro_customize_partial_slider() {
    get_theme_mod('homepage_option_slider');
}
function eightstore_pro_customize_partial_featured() {
    get_theme_mod('feature_post_zero');
}
function eightstore_pro_customize_partial_featured_one() {
    get_theme_mod('feature_post_one_title');
}
function eightstore_pro_customize_partial_featuredtwo() {
    get_theme_mod('feature_post_two_title');
}
function eightstore_pro_customize_partial_featured_three() {
    get_theme_mod('feature_post_three_title');
}
function eightstore_pro_customize_partial_featured_four() {
    get_theme_mod('feature_post_four_title');
}