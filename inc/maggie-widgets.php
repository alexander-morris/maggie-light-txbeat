 ...
 * @since maggie Widget Pack 1.0
 */
require get_template_directory() . '/inc/widgets/widget-editorpick.php';
 ...
 * @since maggie Widget Pack 1.0
 */
require get_template_directory() . '/inc/widgets/widget-categories-tabbed.php';